...
if (!isset($_SESSION['admin_email'])) {
    ...
    <?php
        ...
        if (isset($_POST['submit'])) {
            ...
            $insert_user = "insert into admins (admin_name,admin_email,admin_pass,admin_district,admin_contact,admin_job,admin_image,admin_about) values ('$user_name','$user_email',md5('$user_pass'),'$user_district','$user_contact','$user_job','$user_image','$user_about')";
