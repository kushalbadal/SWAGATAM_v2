    ...
    <ul class="nav navbar-right top-nav"><!-- nav navbar-right top-nav begin -->
        ...
        <li class="dropdown"><!-- dropdown begin -->
            ...
            <ul class="dropdown-menu"><!-- dropdown-menu begin -->
                ...
                <li><!-- li begin -->
                    <a href="index.php?view_Hosts"><!-- a href begin -->
                        
                        <i class="fa fa-fw fa-envelope"></i> Hosts
                        
                        <span class="badge"><?php echo $count_hosts; ?></span>
        ...
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#products"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-tag"></i>Facilities
                ...
                <ul id="products" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?insert_facilities"> Insert Facilities</a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_facilities"> View Facilities</a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#manufacturer"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-star"></i> Hosts
                        <i class="fa fa-fw fa-caret-down"></i>
                ...
                <ul id="manufacturer" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?insert_hosts"> Insert Host </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_hosts"> View Host </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
            ...
            <li><!-- li begin -->
                <a href="index.php?view_booking"><!-- a href begin -->
