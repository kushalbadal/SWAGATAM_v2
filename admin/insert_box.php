...
<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        $desc_image = $_FILES['desc_image']['name'];
              
              $temp_name = $_FILES['desc_image']['tmp_name'];

              move_uploaded_file($temp_name,"other_images/$desc_image");
        $insert_box ="insert into boxes_section (box_title,box_image) values ('$box_title','$desc_image')";
