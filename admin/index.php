<?php 
    ...
    if(!isset($_SESSION['admin_email'])){
        ...
        $count_hosts = mysqli_num_rows($run_host);
...
<head>
    ...
    <title>Swagatam Admin Panel</title>
       ...
       <?php include("includes/sidebar.php"); ?>
        ...
        <div id="page-wrapper"><!-- #page-wrapper begin -->
            <div class="container-fluid"><!-- container-fluid begin -->
                ...
                }   if(isset($_GET['insert_facilities'])){
                        
                        include("insert_facilities.php");
                        
                }   if(isset($_GET['view_facilities'])){
                        
                        include("view_facilities.php");
                        
                }   if(isset($_GET['delete_facilities'])){
                        
                        include("delete_facilities.php");
                        
                }   if(isset($_GET['edit_facilities'])){
                        
                        include("edit_facilities.php");
                        
                } if(isset($_GET['analytic'])){
                ...
                }    if(isset($_GET['insert_hosts'])){
                        
                        include("insert_hosts.php");
                        
                }   if(isset($_GET['view_hosts'])){
                        
                        include("view_hosts.php");
                        
                }   if(isset($_GET['delete_hosts'])){
                        
                        include("delete_hosts.php");
                        
                }   if(isset($_GET['edit_hosts'])){
                        
                        include("edit_hosts.php");
